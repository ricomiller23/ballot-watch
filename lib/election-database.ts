...
export const SENATE_RACES_2026: ElectionOffice[] = [
  ...
  },
  {
    ...
    "state": "Montana",
    "stateAbbr": "MT",
    "title": "Montana U.S. Senate (Class II)",
    "seatClass": "Class II",
    "incumbentParty": "REP",
    "isOpenSeat": false,
    "cookRating": "Likely R",
    "sabatoRating": "Likely R",
    "insideElecRating": "Likely R",
    "pollAverageLead": "R +10.2%",
    "leadingParty": "REP",
    "demCandidate": {
      "name": "Ryan Busse",
      "party": "DEM",
      "status": "Challenger",
      "priorOffice": "Author / 2024 Gubernatorial Nominee",
  ...
  },
  {
    ...
    "state": "Ohio",
    "stateAbbr": "OH",
    "title": "Ohio U.S. Senate (Special Election)",
    "seatClass": "Special Election",
    "incumbentParty": "REP",
    "isOpenSeat": false,
    "cookRating": "Toss-up",
    "sabatoRating": "Toss-up",
...
export const GUBERNATORIAL_RACES_2026: ElectionOffice[] = [
  ...
  },
  {
    ...
    "demCandidate": {
      ...
      "party": "DEM",
      "status": "Challenger",
      "priorOffice": "Harris County Judge",
      "cashOnHandMillions": 14.5
    },
    "repCandidate": {
      "name": "Greg Abbott",
...
export const VERIFIED_POLLS_REGISTRY: VerifiedPollEntry[] = [
  {
    ...
    "method": "Live Caller",
    "marginOfError": 3.1,
    "demCandidate": "James Talarico",
    "demPct": 45.0,
    "repCandidate": "John Cornyn",
    "repPct": 49.0,
    "marginSpread": "Cornyn +4.0%",
  ...
  },
  {
    ...
    "method": "Online Panel",
    "marginOfError": 2.9,
    "demCandidate": "Gary Peters",
    "demPct": 49.8,
    "repCandidate": "John James",
    "repPct": 47.0,
    "marginSpread": "Peters +2.8%",
